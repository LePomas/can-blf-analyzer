...
def add_cycle_count(result_df):
    ...
    for i in range(len(result_df)):
        if (result_df.loc[result_df.index[i], 'SystemState_xdu8'] == 5
...
STATE_LABELS = {
    0: 'NULL', 1: '1: NmWait', 2: '2: OldKL30Wait', 3: '3: PreDrive',
    4: '4: DriveDown', 5: '5: DriveUp', 6: '6: PostRun', 7: '7: Off',
    8: '8: Error', 9: '9: Flash', 10: '10: LowVolt',
...
def main():
    ...
    for file in files:
        ...
        result = result[['SystemState_xdu8', 'Duration', 'Start Time', 'End Time', 'SupplyVoltage_xdu16']]
